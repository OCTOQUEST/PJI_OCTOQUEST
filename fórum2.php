...
<body>
    ...
    <div class="card">
        <textarea class= "disciplina" name='titulo_questao' cols = "65" rows = "2" placeholder="Insira a disciplina"></textarea>
        <textarea class="questao" name='descricao' cols="65" rows="8" placeholder="Insira a questão"></textarea>
        <textarea class="resposta" name = 'resposta' cols="65" rows="3" placeholder="Insira a resposta da questão"></textarea>
